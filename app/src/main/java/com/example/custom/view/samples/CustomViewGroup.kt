...
class CustomViewGroup @JvmOverloads constructor(
    ...
    private val animator = ValueAnimator
        ...
        .apply {
            ...
            interpolator = TwoStepInterpolator()
    ...
    init {
        context.withStyledAttributes(attr, R.styleable.CustomViewGroup, defStyleAttr) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val width = when (widthMode) {
            ...
            MeasureSpec.AT_MOST -> if (childrenOnSameLine) {
    ...
    @SuppressLint("NewApi")
    class TwoStepInterpolator : BaseInterpolator() {
